        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <!--    @else -->
                    <!--    <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('public/backend/img/avatar.png')}}" alt="profile picture">-->
                    <!--    @endif-->
                    <!--</div>-->
