...
<div class="card">
  ...
  <div class="card-body">
    @if($message)
        @if($message->photo)
        <img src="{{asset('public/'.$message->photo)}}" class="rounded-circle " style="margin-left:44%;">
        @else 
        <img src="{{asset('public/backend/img/avatar.png')}}" class="rounded-circle " style="margin-left:44%;">
        @endif
