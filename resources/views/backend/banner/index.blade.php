          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>
                        @if($banner->photo)
                            <img src="{{asset('public/'.$banner->photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{asset($banner->photo)}}">
                        @else
                            <img src="{{asset('public/backend/img/thumbnail-default.jpg')}}" class="img-fluid zoom" style="max-width:100%" alt="avatar.png">
                        @endif
                    </td>
                    <td>
