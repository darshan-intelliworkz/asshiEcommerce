    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group"> 
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Enter title"  value="{{ old('title', $category->title)}}" class="form-control">
          @error('title')
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="gst" placeholder="Enter GST"  value="{{$category->gst}}" class="form-control">
          @error('gst')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
